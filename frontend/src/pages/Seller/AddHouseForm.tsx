...
import { Wifi, Car, TreePine, X, Image as ImageIcon, MapPin, Ruler, BedDouble, Bath, Layout, Utensils, Construction, Home, Zap, Droplets, Grid3X3, Layers } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto py-10 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-2">
                ...
                {errors.title && <p className="text-red-500 text-[10px] font-bold uppercase">{errors.title.message as string}</p>}
            </div>
        </div>
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <input {...register('province')} placeholder="Province" className="p-4 border-2 border-gray-100 rounded-2xl font-bold bg-gray-50 outline-none" />
                <input {...register('district')} placeholder="District" className="p-4 border-2 border-gray-100 rounded-2xl font-bold bg-gray-50 outline-none" />
                <input {...register('sector')} placeholder="Sector" className="p-4 border-2 border-gray-100 rounded-2xl font-bold bg-gray-50 outline-none" />
            </div>
