...
const schema = z.object({
  ...
  price_per_night: z.preprocess(val => Number(val), z.number().positive().optional()),
  price_per_event: z.preprocess(val => Number(val), z.number().positive().optional()),
  images: z.any()
...
const AddAccommodationForm = () => {
  ...
  const { register, handleSubmit, formState: { errors }, watch } = useForm({ resolver: zodResolver(schema), defaultValues: { type: 'apartment' } });
